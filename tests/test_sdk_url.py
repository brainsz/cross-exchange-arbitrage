"""
Test using the correct SDK stream URL.
"""
import asyncio
import json
import os
...
async def test_orderbook_ws():
    """Test orderbook WebSocket connection using SDK URL."""
    ticker = "ETH"
    # Build the full URL like the SDK does
    ...
    try:
        async with websockets.connect(
            ...
            async for raw in ws:
                ...
                print(f"Message preview: {json.dumps(msg, indent=2)[:400]}")
...
async def main():
    print("=" * 50)
    print("Testing with SDK stream URL")
    print("=" * 50)
